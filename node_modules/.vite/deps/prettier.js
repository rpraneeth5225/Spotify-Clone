...
var O = "label";
var k = "break-parent";
var Ue = /* @__PURE__ */ new Set([W, T, S, v, _, w, x, P, L, I, A, O, k]);
function xu(e) {
  if (typeof e == "string")
    return M;
  if (Array.isArray(e))
...
var U = xu;
var wu = (e) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(e);
function ku(e) {
...
function Gu(e, t) {
  ...
  for (let o of zu)
    o in t && (n[o] = Ku(t[o], r, b.prototype[o].length));
  return n;
}
var b = class {
  static create(t) {
...
export {
  ...
  er as doc,
  cu as format,
  au as formatWithCursor,
  ti as getSupportInfo,
  Qt as util,
  Du as version
};
